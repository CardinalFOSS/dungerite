...
public class DungeriteClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ClientSpriteRegistryCallback.event(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE)
                .register(
                        (atlasTexture, registry) ->
                                registry.register(
                                        new Identifier(
                                                Dungerite.MOD_ID, "particle/fart_particle")));
        ...
        EntityRendererRegistryImpl.register(
                Dungerite.DungEntityType, FlyingItemEntityRenderer::new);
        EntityRendererRegistryImpl.register(
                Dungerite.SeaweedBombEntityType, FlyingItemEntityRenderer::new);
        EntityRendererRegistryImpl.register(
                Dungerite.DungCannonballEntityType, FlyingItemEntityRenderer::new);
        receiveEntityPacket();
                    ...
                    client.execute(
                            () -> {
                                PlayerEntity effectPlayer =
                                        client.player
                                                .getEntityWorld()
                                                .getPlayerByUuid(effectPlayerUuid);
