...
public class DungeriteHoe extends SwordItem {
    public DungeriteHoe(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.MINING_FATIGUE, 3 * secsToTicks, 0));
