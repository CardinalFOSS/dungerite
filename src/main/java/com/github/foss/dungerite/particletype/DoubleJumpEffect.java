...
public class DoubleJumpEffect {
  ...
  public static void play(PlayerEntity localPlayer, PlayerEntity effectPlayer) {
    ...
    world.playSound(
        localPlayer, effectPlayer.getBlockPos(), Dungerite.FART, SoundCategory.PLAYERS, 0.4f, 1);
    ...
    for (int i = 0; i < 5; ++i) {
      ...
      world.addParticle(
          Dungerite.FART_PARTICLE,
          effectPlayer.getParticleX(1.0D),
          effectPlayer.getY(),
          effectPlayer.getParticleZ(1.0D),
          d,
          e,
          f);
    }
