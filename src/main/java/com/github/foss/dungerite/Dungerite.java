...
public class Dungerite implements ModInitializer {
  ...
  public static final Identifier PACKET_ID =
      new Identifier(Dungerite.MOD_ID, "spawn_packet"); // used for creating entity server-side
  ...
  // Blocks
  public static final DungBlock DUNG_BLOCK =
  ...
  // ItemGroup
  public static final ItemGroup DUNG_GROUP =
  ...
  // Entities
  public static final EntityType<DungEntity> DungEntityType =
          ...
          FabricEntityTypeBuilder.<DungEntity>create(SpawnGroup.MISC, DungEntity::new)
              .dimensions(
                  EntityDimensions.fixed(
                      0.25f, 0.25f)) // dimensions in Minecraft units of the projectile
              .trackRangeBlocks(4)
              .trackedUpdateRate(
  ...
  public void onInitialize() {
    ...
    Registry.register(
        Registry.ITEM,
        new Identifier(MOD_ID, "dung_block"),
        new BlockItem(DUNG_BLOCK, new FabricItemSettings().group(ItemGroup.MISC)));
    ...
    DispenserBlock.registerBehavior(
        ...
        new ProjectileDispenserBehavior() {
          ...
          protected ProjectileEntity createProjectile(
            ...
            return Util.make(
                new DungEntity(world, position.getX(), position.getY(), position.getZ()),
    ...
    DispenserBlock.registerBehavior(
        ...
        new ProjectileDispenserBehavior() {
          ...
          protected ProjectileEntity createProjectile(
              World world, Position position, ItemStack stack) {
            return Util.make(
                new SeaweedBombEntity(world, position.getX(), position.getY(), position.getZ()),
                (entity) -> entity.setItem(stack));
          }
        });
    ...
    ServerPlayNetworking.registerGlobalReceiver(
        ...
        (server, player, handler, buf, responseSender) -> {
          ...
          // looks up players on the server and determines if they're the player who executed double
          // jump
